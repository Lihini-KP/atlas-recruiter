...
const SIDEBAR_ITEMS = [
  ...
  { label: 'Interview', href: 'module-pending.html?name=Interview&phase=4', icon: '🎤' },
  { label: 'Offer Letter', href: 'module-pending.html?name=Offer+Letter&phase=5', icon: '📄' },
  { label: 'Hiring', href: 'module-pending.html?name=Hiring&phase=5', icon: '🤝' },
