...
const SIDEBAR_ITEMS = [
  ...
  { label: 'New Recruitment Request', href: 'index.html' },
  { label: 'HR Review', href: 'hr-review.html', roles: ['hr', 'admin'] },
  { label: 'CEO Approval', href: 'ceo-approval.html', roles: ['ceo', 'admin'] },
  { label: 'Advertisement', href: 'module-pending.html?name=Advertisement&phase=1' },
  { label: 'CV Folder', href: 'module-pending.html?name=CV+Folder&phase=1' },
